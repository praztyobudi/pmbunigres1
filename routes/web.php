...
use App\Http\Controllers\Administrator\Master\JalurMasukController as MasterJalurMasukController;
...
Route::middleware(['auth'])->prefix('/administrator')->name('administrator.')->group(function(){
    ...
    Route::get('/aapp', function(){
        ...
        $client = new Client(['base_uri' => 'http://siakad.aakdelimahusadagresik.ac.id/api/']);
    ...
    Route::name('master.')->middleware('can:admin')->group(function(){
        ...
        Route::resource('jalur-masuk', MasterJalurMasukController::class)->only(['index', 'store', 'destroy']);
