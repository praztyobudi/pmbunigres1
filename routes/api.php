...
use App\Http\Controllers\Admin\Api\BiayaController as MasterBiayaController;
...
Route::name('biaya')->group(function(){
    Route::get('/getKelas/byProdi/{prodi}', [MasterBiayaController::class, 'getKelas'])->name('getKelasByProdi');
    Route::get('/getJalurMasuk/byKelas/{kelas}', [MasterBiayaController::class, 'getJalurMasuk'])->name('getJalurMasukByKelas');
    Route::get('/getBiaya/byGelombang/{gelombang}/byKelas/{kelas}/byJalurMasuk/{jalurMasuk}', [MasterBiayaController::class, 'getBiaya'])->name('getBiayaByGelombangByKelasByJalurMasuk');
});
