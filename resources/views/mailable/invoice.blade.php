...
<head>
    ...
    <title>AAK Delima Husada Gresik</title>
    <style>
...
<div style="width: 100% !important; margin: 0 auto; background-color: #E5E5E5; padding:32px 0px;">
    <div style="max-width: 954px; margin: auto; background-color: #ffffff; border-radius: 6px; padding: 0px 32px 42px 32px; margin-bottom: 18px;">
        <div class="col-12" style="border-bottom: .6px solid rgba(0, 0, 0, 0.137); padding: 24px 0px; overflow: auto">
            <div class="col-6 left">
                <img class="left" src="https://i.ibb.co/yP5mk5m/logo.png" style="width: 48px; margin-right: 12px; vertical-align: middle">
                <p style="font-family: Helvetica, sans-serif;
                    font-size: 24px;
                    color: #0078BA; margin: 8.461px 0;">PMB.<span style="font-weight: bold;">AAK Delima Husada Gresik</span></p>
            </div>
            <a class="col-6 right" href="http://www.aakdelimahusadagresik.ac.id" style="text-decoration: none;">
                <img class="right" style="margin: 10.46px 0 10.46px 10px; width: 24px;" src="https://i.ibb.co/WgtXkYn/notification-active.png">
                <p class="right" style="font-size: 16px; color: #11222B; font-family: Arial, Helvetica, sans-serif; margin: 13.46px 0px;">www.aakdelimahusadagresik.ac.id</p>
            </a>
        </div>
        ...
        <div style="color: #11222B; margin: 42px 0px 0px 0px;">
            ...
            <div style="color: #8F8E94; font-size: smaller">
                ...
                <ol type="1">
                    ...
                    <li>Masukkan 5 angka Kode Perusahaan untuk AAK Delima Husada Gresik (10004) dan kode pembayaran (contoh: 10004 1234567890)</li>
    ...
    <div style="max-width: 954px; margin: auto; background-color: #ffffff; border-radius: 6px; padding: 32px;">
        <p>Abaikan email ini apabila anda tidak merasa mendaftar pada AAK Delima Husada Gresik atau sudah melakukan pembayaran. Cek status pembayaran anda
            <a href="{{ route('login') }}">disini</a>.</p>
        <p  style="text-align: center; font-size: 18px; font-weight: normal; color: #8F8E94; margin: 32px 0px 18px; padding-top: 32px; border-top: 1px solid rgba(0, 0, 0, 0.137);">Untuk informasi lebih lanjut mengenai PMB AAK Delima Husada Gresik silahkan hubungi call center di bawah ini.</p>
