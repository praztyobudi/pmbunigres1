            ...
            <form action="{{ route('administrator.keuangan.biaya.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="academicBook">Buku Pedoman Akademik</label>
                            <input type="number" name="academicBook" id="academicBook" class="form-control form-control-sm" min="0" step="1000" required>
                        </div> {{-- Heregistrasi --}}
                        <div class="form-group">
                            <label for="competentionBook">Buku Pedoman Kompetensi</label>
                            <input type="number" name="competentionBook" id="competentionBook" class="form-control form-control-sm" min="0" step="1000" required>
                        </div> {{-- SPP Semester 1 --}}
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="hijab" id="hijab" class="form-control form-control-sm">
                                <option value="" selected disabled>--- Pilih Kriteria Hijab ---</option>
                            ...
                            <table class="table table-bordered table-striped dataTable table-responsive">
                                ...
                                @foreach($phase->biaya as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->hijab)
                                                <span class="badge bg-info">Hijab</span>
                                            @endif
                                            {{ $row->jalurMasuk->jalur_masuk }}
                                        </td>
                                        ...
                                        <td>Rp. {{ number_format($row->buku_pedoman_akademik, 0, '', '.') }},-</td>
                                        <td>Rp. {{ number_format($row->buku_pedoman_kompetensi, 0, '', '.') }},-</td>
...
@section('js')
    <script>
        ...
        resetClass = () => {
            ...
            $('#academicBook').val(null);
            $('#competentionBook').val(null);
            $('#uniform').val(null);
            $('#hijab').val(null);
            $('#total').val(null);
        }
        ...
        editCost = (e) => {
            ...
            $('#academicBook').val(costData.buku_pedoman_akademik);
            $('#competentionBook').val(costData.buku_pedoman_kompetensi);
            $('#uniform').val(costData.seragam);
            $('#hijab').val(costData.hijab);
