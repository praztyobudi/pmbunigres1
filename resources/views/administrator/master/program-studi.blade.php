            ...
            <form action="{{ route('administrator.master.prodi.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="test_link">Link TPA</label>
                            <input type="text" class="form-control form-control-sm" id="test_link" name="test_link">
                        </div>
                    </div>
                        ...
                        <td>
                            <form action="{{ route('administrator.master.prodi.destroy', $row->id) }}" method="POST">
                                ...
                                <div class="btn-group btn-group-sm">
                                    <button type="button" class="btn btn-warning" id="btn-edit" data-toggle="modal" data-target="#addMajor" data-id="{{$row->id}}" data-level="{{$row->jenjang->id}}" data-faculty="{{$row->fakultas->id??null}}" data-major="{{$row->nama}}" data-student-code="{{$row->kode_prodi_nim}}" data-system-code="{{$row->kode_prodi_siakad}}" data-test-link="{{$row->link_tpa}}" onclick="edit(this)"><i class="fas fa-pencil-alt"></i></button>
...
@section('js')
    <script>
        ...
        edit = (e) => {
            ...
            let test_link = collection.data('test-link');
