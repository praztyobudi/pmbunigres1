...
class BiayaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'academicBook' => 'required|numeric|min:0',
            'competentionBook' => 'required|numeric|min:0',
        ...
        try {
            ...
            $data = [
                ...
                'buku_pedoman_akademik' => $validatedData['academicBook'] ?? 0,
                'buku_pedoman_kompetensi' => $validatedData['competentionBook'] ?? 0,
                'seragam' => $validatedData['uniform'] ?? 0,
                'hijab' => $validatedData['hijab'] ?? 0,
