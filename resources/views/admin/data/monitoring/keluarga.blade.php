    ...
    <div class="content">
        <div class="container-fluid dashboard-user">
            ...
            <ul class="nav nav-pills mb-5 mx-auto">
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('admin.monitoring.pendaftar.biodata.index', $dataAyah->biodata->user_id) }}" type="button">Data Calon Mahasiswa</a>
                </li>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pr-2">
                                                ...
                                                <input type="text" name="nama_ayah" id="nama_ayah" class="form-control form-control-sm" value="{{ $dataAyah->nama ?? old('nama_ayah') }}" required>
                                            </div>
                                            <div class="col-md-6 pl-2">
                                                <label for="status_ayah">Status</label>
                                                <select name="status_ayah" id="status_ayah" class="form-control form-control-sm"  required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="alamat_ayah" id="alamat_ayah" cols="30" class="form-control form-control-sm" required>{{ $dataAyah->alamat ?? old('alamat_ayah') }}</textarea>
                                            </div>
                                            <div class="col-md-6 pr-2">
                                                <label for="pekerjaan_ayah">Pekerjaan Ayah</label>
                                                <input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" class="form-control form-control-sm" value="{{ $dataAyah->pekerjaan ?? old('pekerjaan_ayah') }}" required>
                                            </div>
                                            <div class="col-md-6 pl-2">
                                                <label for="gaji_ayah">Gaji</label>
                                                <input type="number" name="gaji_ayah" id="gaji_ayah" class="form-control form-control-sm" value="{{ $dataAyah->gaji ?? old('gaji_ayah') }}" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="no_telepon_ayah">No. Telepon</label>
                                                <input type="text" name="no_telepon_ayah" id="no_telepon_ayah" class="form-control form-control-sm" value="{{ $dataAyah->telepon ?? old('no_telepon_ayah') }}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pr-2">
                                                ...
                                                <input type="text" name="nama_ibu" id="nama_ibu" class="form-control form-control-sm" value="{{ $dataIbu->nama ?? old('nama_ibu') }}" required>
                                            </div>
                                            <div class="col-md-6 pl-2">
                                                <label for="status_ibu">Status</label>
                                                <select name="status_ibu" id="status_ibu" class="form-control form-control-sm" required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="alamat_ibu" id="alamat_ibu" cols="30" class="form-control form-control-sm" required>{{ $dataIbu->alamat ?? old('alamat_ibu') }}</textarea>
                                            </div>
                                            <div class="col-md-6 pr-2">
                                                <label for="pekerjaan_ibu">Pekerjaan Ibu</label>
                                                <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" class="form-control form-control-sm" value="{{ $dataIbu->pekerjaan ?? old('pekerjaan_ibu') }}" required>
                                            </div>
                                            <div class="col-md-6 pl-2">
                                                <label for="gaji_ibu">Gaji</label>
                                                <input type="number" name="gaji_ibu" id="gaji_ibu" class="form-control form-control-sm" value="{{ $dataIbu->gaji ?? old('gaji_ibu') }}" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="no_telepon_ibu">No. Telepon</label>
                                                <input type="text" name="no_telepon_ibu" id="no_telepon_ibu" class="form-control form-control-sm" value="{{ $dataIbu->telepon ?? old('no_telepon_ibu') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pr-2">
                                                ...
                                                <input type="text" name="nama_wali" id="nama_wali" class="form-control form-control-sm" value="{{ $dataWali->nama ?? old('nama_wali') }}">
                                            </div>
                                            <div class="col-md-6 pl-2">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="alamat_wali" id="alamat_wali" cols="30" class="form-control form-control-sm">{{ $dataWali->alamat ?? old('alamat_wali') }}</textarea>
                                            </div>
                                            <div class="col-md-6 pr-2">
                                                <label for="pekerjaan_wali">Pekerjaan</label>
                                                <input type="text" name="pekerjaan_wali" id="pekerjaan_wali" class="form-control form-control-sm" value="{{ $dataWali->pekerjaan ?? old('pekerjaan_wali') }}">
                                            </div>
                                            <div class="col-md-6 pl-2">
                                                <label for="gaji_wali">Gaji</label>
                                                <input type="number" name="gaji_wali" id="gaji_wali" class="form-control form-control-sm" value="{{ $dataWali->gaji ?? old('gaji_wali') }}">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="no_telepon_wali">No. Telepon</label>
                                                <input type="text" name="no_telepon_wali" id="no_telepon_wali" class="form-control form-control-sm" value="{{ $dataWali->telepon ?? old('no_telepon_wali') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
